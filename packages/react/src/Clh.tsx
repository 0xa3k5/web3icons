...
const IconClh = forwardRef<SVGSVGElement, IconComponentProps>(({ variant = 'mono', ...props }, ref) => (
    ...
    <path fill="url(#CLH__a)" d="M13.089 6a.23.23 0 0 0-.232.231V8.34a.23.23 0 0 0 .232.231h2.768v2.769a.23.23 0 0 0 .146.214.2.2 0 0 0 .086.017h2.108a.235.235 0 0 0 .232-.231V6z"/>
    <defs>
        <linearGradient id="CLH__a" x1="12.857" x2="18.429" y1="8.786" y2="8.786" gradientUnits="userSpaceOnUse">
