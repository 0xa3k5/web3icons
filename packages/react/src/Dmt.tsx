...
const IconDmt = forwardRef<SVGSVGElement, IconComponentProps>(({ variant = 'mono', ...props }, ref) => (
    ...
    <path fill="url(#DMT__b)" d="M8.134 5.143h.139c-.551 0-.456.377-.414.453L9.648 8.57l1.72 2.847a1.17 1.17 0 0 1 0 1.164l-1.72 2.846s-1.445 2.394-1.789 2.911c0 0-.275.518.413.518h6.605-6.742c-.07 0-.428.03-.703-.164a2 2 0 0 1-.42-.397L5.726 16.14c-.206-.323-.206-.712 0-.97l1.49-2.6c.084-.137.126-.377.126-.57 0-.112-.075-.334-.2-.576l-1.41-2.586c-.207-.324-.207-.711 0-.97l1.303-2.2a1 1 0 0 1 .43-.4c.215-.12.462-.125.67-.125"/>
    <defs>
        <linearGradient id="DMT__a" x1="19.286" x2="8.295" y1="12.001" y2="12.001" gradientUnits="userSpaceOnUse">
            <stop stopColor="#01FBDF"/>
            <stop offset="1" stopColor="#009299"/>
        </linearGradient>
        <linearGradient id="DMT__b" x1="5.571" x2="11.581" y1="12" y2="12" gradientUnits="userSpaceOnUse">
