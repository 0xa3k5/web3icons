...
const IconAlpha = forwardRef<SVGSVGElement, IconComponentProps>(
    ...
    <BaseIcon {...props} ref={ref}>
      {variant === 'mono' ? (
        <>
          <path
            fill="currentColor"
            d="M12 4.714v5.13l.943 2.315-.943-.785v2.465l.03.03a18.4 18.4 0 0 0 5.542 4.56zM12 4.714v5.13l-.943 2.315.943-.785v2.465l-.03.03a18.4 18.4 0 0 1-5.541 4.56z"
          />
          <path
            fill="currentColor"
        ...
        <>
          <g clipPath="url(#ALPHA__a)">
            <path fill="#000749" d="M0 0h24v24H0z" />
            <path
              fill="url(#ALPHA__b)"
