...
const IconLunr = forwardRef<SVGSVGElement, IconComponentProps>(({ variant = 'mono', ...props }, ref) => (
    ...
    <defs>
        <linearGradient id="LUNR__a" x1="9.874" x2="9.874" y1="5.571" y2="9.63" gradientUnits="userSpaceOnUse">
