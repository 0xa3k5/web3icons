...
const IconMln = forwardRef<SVGSVGElement, IconComponentProps>(({ variant = 'mono', ...props }, ref) => (
...
IconMln.variants = 'brandedmono';

export default IconMln;
