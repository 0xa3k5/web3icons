...
const IconNett = forwardRef<SVGSVGElement, IconComponentProps>(
    ...
    <BaseIcon {...props} ref={ref}>
      {variant === 'mono' ? (
        <>
          <path
            fill="currentColor"
            d="m8.58 12-4.165 5.177c-.146-.085-.133-.325-.112-.437L5.336 12zm2.97 2.122L8.584 12 4.41 17.186c.094.116.33.086.433.051zM8.585 12H5.332A1048 1048 0 0 1 6.78 6.883a.54.54 0 0 1 .253-.283z"
          />
          <path
            fill="currentColor"
        ...
        <>
          ...
          <path
            fill="#54CCFF"
            d="M8.585 12H5.332A1048 1048 0 0 1 6.78 6.883a.54.54 0 0 1 .253-.283z"
          />
          <path
            fill="#A2AFFE"
            d="M7.5 6.604c-.18-.12-.386-.05-.471 0l1.56 5.4 6.981.425c-2.614-1.869-7.886-5.7-8.07-5.825"
