...
export const NetworkOsmosis = forwardRef<SVGSVGElement, IconComponentProps>(
    ...
    <BaseIcon {...props} ref={ref}>
      {variant === 'mono' ? (
        ...
        <>
          ...
          <path
            fill="url(#osmosis__b)"
            d="M16.971 8.58c.9.257 1.265-.454 1.145-.93-.129-.48-.54-.964-1.273-1.513-.729-.548-1.466-.771-1.942-.668-.471.098-.608.84-.493 1.122.052.112.159.275.309.46-.189.128-.369.23-.514.325a5.83 5.83 0 0 1 2.288 1.877q.1-.375.257-.729a1 1 0 0 1 .223.056"
          />
          <path
            fill="url(#osmosis__c)"
          ...
          <path
            fill="#A98698"
            d="M17.661 7.183a3.64 3.64 0 0 0-2.138-1.2c-.592-.141-.433-.484.287-.416a1.76 1.76 0 0 0-.909-.098c-.471.098-.608.84-.493 1.122.052.112.159.275.309.46q-.332.225-.686.415c.37.168.717.386 1.029.647-.553-.484-.433-.707.326-1.256.235-.171.668-.154 1.071.06.407.215.879.75.879.75l-.45.896.085.03c.287.081.515.06.69-.013.21-.129.75-.578 0-1.397"
          />
          <path
            fill="#5E12A0"
            d="M15.514 6.472c.63.29 1.198.697 1.676 1.2a5.4 5.4 0 0 0-.712 1.547l.215.304c.073-.253.193-.626.347-1.003a.5.5 0 0 0 .141.013.54.54 0 0 0 .365-.116.42.42 0 0 0 .158-.373q.001-.29-.454-.728a7 7 0 0 0-.81-.66c-.849-.579-1.44-.742-1.706-.472-.176.185-.158.407-.098.57-.313.215-.583.369-.759.472.12.038.227.085.343.137q.687-.39 1.294-.891m1.864 1.451c.03.047.039.099.039.129 0 .094-.03.124-.051.141a.34.34 0 0 1-.185.052c.056-.12.129-.223.197-.322M14.94 6.411c.03-.03.111-.05.24-.03-.099.082-.197.15-.3.223-.009-.072 0-.141.06-.192"
          />
          <path
            fill="url(#osmosis__d)"
          ...
          <path
            fill="#fff"
            d="M13.714 10.286a.857.857 0 1 0 0-1.714.857.857 0 0 0 0 1.714m1.286.857a.43.43 0 1 0 0-.858.43.43 0 0 0 0 .858"
          />
          <path
            fill="url(#osmosis__i)"
          ...
          <path
            fill="#fff"
            d="M11.473 17.083a.28.28 0 0 0 .274-.283.28.28 0 0 0-.274-.287.28.28 0 0 0-.279.287c0 .154.129.283.279.283"
          />
          <path
            fill="#fff"
            d="M11.314 16.98a.296.296 0 0 1 0-.403l.06-.051a.2.2 0 0 0-.098.06.295.295 0 0 0 0 .407.28.28 0 0 0 .334.047.27.27 0 0 1-.3-.06zm.257-.266a.06.06 0 0 0 .055-.037.06.06 0 0 0-.105-.056.06.06 0 0 0-.01.033c0 .035.026.065.06.065zm1.342.228c.15 0 .274-.13.274-.288a.28.28 0 0 0-.274-.282.286.286 0 0 0 0 .57"
          />
          <path
            fill="#fff"
            d="M12.754 16.843a.296.296 0 0 1 0-.412l.06-.047a.2.2 0 0 0-.098.06.296.296 0 0 0 0 .403.27.27 0 0 0 .334.052.27.27 0 0 1-.3-.06zm.257-.27c.03 0 .056-.026.056-.06a.06.06 0 0 0-.016-.041.06.06 0 0 0-.04-.02.06.06 0 0 0-.06.06.06.06 0 0 0 .06.061m-.81 1.029a.21.21 0 0 0 .206-.215c0-.12-.09-.214-.206-.214a.2.2 0 0 0-.147.065.2.2 0 0 0-.058.15c0 .115.09.214.205.214"
          />
          <path
            fill="url(#osmosis__j)"
          ...
          <path
            fill="#fff"
            d="M10.041 16.809a.47.47 0 0 1 0-.66.4.4 0 0 1 .099-.073c-.06.021-.107.064-.159.103a.47.47 0 0 0 0 .66c.15.154.377.184.557.073a.43.43 0 0 1-.497-.103m.416-.437a.1.1 0 0 0 .092-.064.1.1 0 0 0 .007-.039.1.1 0 0 0-.028-.07.1.1 0 0 0-.071-.029.1.1 0 0 0-.07.028.1.1 0 0 0-.029.071c0 .06.043.103.099.103m3.891-.536a.464.464 0 0 0 .455-.472.455.455 0 0 0-.455-.463.46.46 0 0 0-.45.468.46.46 0 0 0 .45.467"
          />
          <path
            fill="url(#osmosis__k)"
          ...
          <path
            fill="#fff"
            d="M14.507 15.227c.056 0 .099-.043.099-.103a.1.1 0 0 0-.028-.072.1.1 0 0 0-.071-.031c-.056 0-.099.043-.099.103a.1.1 0 0 0 .028.072.1.1 0 0 0 .071.031"
          />
          <path
            fill="#5E12A0"
...
NetworkOsmosis.displayName = 'osmosis'
