...
export const NetworkArbitrum = forwardRef<SVGSVGElement, IconComponentProps>(
    ...
    <BaseIcon {...props} ref={ref}>
      {variant === 'mono' ? (
        <>
          <path
            fill="currentColor"
            d="m13.149 13.766-.75 2.045a.24.24 0 0 0 0 .18l1.286 3.522 1.495-.857-1.791-4.89a.129.129 0 0 0-.24 0m1.5-3.445a.128.128 0 0 0-.24 0l-.75 2.044a.24.24 0 0 0 0 .18l2.113 5.768 1.491-.857-2.614-7.14z"
          />
          <path
            fill="currentColor"
          ...
          <path
            fill="currentColor"
            d="m8.242 18.322.522-1.427 1.05.87-.98.9z"
          />
          <path
            fill="currentColor"
            d="M11.525 8.735H10.08a.26.26 0 0 0-.24.175l-3.085 8.542 1.487.87 3.403-9.407a.13.13 0 0 0-.016-.122.13.13 0 0 0-.109-.058zm2.52 0h-1.44a.26.26 0 0 0-.24.171l-3.532 9.746 1.492.87 3.84-10.61a.13.13 0 0 0-.12-.177"
          />
        </>
      ) : (
        <>
          ...
          <path
            fill="#fff"
            d="M11.524 8.143H10.08a.26.26 0 0 0-.24.175L6.754 16.86l1.487.87 3.403-9.407a.135.135 0 0 0-.063-.164.13.13 0 0 0-.061-.016zm2.52 0h-1.44a.26.26 0 0 0-.24.171L8.833 18.06l1.491.87 3.84-10.611a.13.13 0 0 0-.06-.161.13.13 0 0 0-.06-.015"
          />
        </>
      )}
    </BaseIcon>
...
NetworkArbitrum.displayName = 'arbitrum'
