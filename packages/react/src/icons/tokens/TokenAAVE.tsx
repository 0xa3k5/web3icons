...
export const TokenAAVE = forwardRef<SVGSVGElement, IconComponentProps>(
      ...
      {variant === 'mono' ? (
        ...
        <>
          ...
          <defs>
            ...
            >
              <stop stopColor="#B14992" />
              <stop offset=".24" stopColor="#925C9A" />
              <stop offset=".492" stopColor="#647BA6" />
              <stop offset=".671" stopColor="#3896B1" />
              <stop offset=".956" stopColor="#00ABBB" />
            </linearGradient>
          </defs>
        </>
      )}
