...
export const TokenNSFW = forwardRef<SVGSVGElement, IconComponentProps>(
    ...
    <BaseIcon {...props} ref={ref}>
      {variant === 'mono' ? (
        <>
          <path
            fill="currentColor"
            d="M12 18.857V11.57H4.286zm0 0V11.57h7.714zm4.071-12L12 11.57h7.714z"
          />
          <path
            fill="currentColor"
            d="m7.929 6.857 4.07 4.714H4.287zM12 11.571V8.73l4.071-1.873z"
          />
