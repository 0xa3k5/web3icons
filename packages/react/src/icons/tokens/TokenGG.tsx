...
export const TokenGG = forwardRef<SVGSVGElement, IconComponentProps>(
  ({ ...props }, ref) => (
    <BaseIcon {...props} ref={ref}>
      ...
      <path
        fill="url(#GG__c)"
        d="m6.858 11.743-2.572-1.38L11.983 6l7.732 4.363-2.572 1.38-5.147-2.872z"
      />
      <defs>
        <linearGradient
          id="GG__a"
