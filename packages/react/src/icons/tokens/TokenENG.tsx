...
export const TokenENG = forwardRef<SVGSVGElement, IconComponentProps>(
  ({ ...props }, ref) => (
    <BaseIcon {...props} ref={ref}>
      <path
        fill="#fff"
        d="m11.977 4.426 6.451 3.702v7.405l-6.451 3.703-6.406-3.703V8.128z"
      />
