...
export const TokenGNS = forwardRef<SVGSVGElement, IconComponentProps>(
    ...
    <BaseIcon {...props} ref={ref}>
      {variant === 'mono' ? (
        <>
          ...
          <path
            fill="currentColor"
            d="M12.467 9.06c.484.129 1.247.467 1.247 1.226v.973c0-.009 0 .008 0 0v3.634c0 .514.326.964.857.964.532 0 .858-.42.858-.943V9.086a.94.94 0 0 0-.472-.81.99.99 0 0 0-.947-.022zm-1.453 4.847-1.071.626c-.154.09-.227.274-.133.428.124.206.334.468.634.66.309.202.639.245.879.236.163-.013.248-.154.248-.317v-1.31c0-.287-.3-.472-.557-.317z"
          />
          <path
            fill="currentColor"
        ...
        <>
          ...
          <path
            fill="url(#GNS__c)"
            d="M12.467 9.06c.484.129 1.247.467 1.247 1.226v.973c0-.009 0 .008 0 0v3.634c0 .514.326.964.857.964s.857-.42.857-.943V9.086a.93.93 0 0 0-.471-.81.99.99 0 0 0-.947-.022z"
          />
          <path
            fill="url(#GNS__d)"
