...
export const TokenSETH2 = forwardRef<SVGSVGElement, IconComponentProps>(
    ...
    <BaseIcon {...props} ref={ref}>
      {variant === 'mono' ? (
        <>
          <path
            fill="currentColor"
            d="M12 12.857V4.286l-3.429 6.643zm0 0V4.286l3.429 6.643zm0 0L8.571 10.93 6 15.857zm0 0 3.429-1.928L18 15.857zm0 6v-6l-6 3z"
          />
