...
export const TokenCLV = forwardRef<SVGSVGElement, IconComponentProps>(
    ...
    <BaseIcon {...props} ref={ref}>
      {variant === 'mono' ? (
        <>
          ...
          <path
            fill="currentColor"
            d="M12 15a3 3 0 1 0-6 0 3 3 0 0 0 6 0m6-6a3 3 0 1 0-6 0 3 3 0 0 0 6 0"
          />
