...
export const TokenFLX = forwardRef<SVGSVGElement, IconComponentProps>(
      ...
      {variant === 'mono' ? (
        ...
        <>
          ...
          <defs>
            ...
            >
              <stop stopColor="#77D8FE" />
              <stop offset="1" stopColor="#4FDF9D" />
            </linearGradient>
          </defs>
        </>
      )}
