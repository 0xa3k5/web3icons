...
export const TokenBZRX = forwardRef<SVGSVGElement, IconComponentProps>(
      ...
      {variant === 'mono' ? (
        ...
        <>
          ...
          <defs>
            ...
            >
              <stop offset=".159" stopColor="#003CDA" />
