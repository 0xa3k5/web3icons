...
const IconBdp = forwardRef<SVGSVGElement, IconComponentProps>(({ variant = 'mono', ...props }, ref) => (
    ...
    <path fill="currentColor" d="M3.537 14.477c-.336.077-.53.363-.53.596 0 .633.645.665.894.633 1.688 0 3.16-1.996 4.285-3.729.95-1.465 1.681-2.742 3.413-2.742 1.627 0 2.597 1.331 3.028 2.112l.675-1.075C14.78 9.497 13.307 8 11.6 8S8.795 9.07 8.261 9.877c-1.494 2.26-2.403 3.699-3.247 4.235-.784.5-1.058.27-1.477.365"/>
