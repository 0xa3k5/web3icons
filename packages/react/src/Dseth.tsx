...
const IconDseth = forwardRef<SVGSVGElement, IconComponentProps>(({ variant = 'mono', ...props }, ref) => (
    ...
    <path fill="currentColor" d="m9.857 15.694-4.714-2.837 4.714 6.857zm4.286 0 4.714-2.837-4.714 6.857zM12 9.214V3.428l-4.714 7.715z"/>
    ...
    <path fill="#B6C5C2" d="M12 9v5.143l-4.715-3zm0 .214V3.428l4.714 7.715z"/>
