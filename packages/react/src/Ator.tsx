...
const IconAtor = forwardRef<SVGSVGElement, IconComponentProps>(
    ...
    <BaseIcon {...props} ref={ref}>
      {variant === 'mono' ? (
        <>
          ...
          <path
            fill="currentColor"
            d="M9 12C7.63 11.657 6.43 9.857 6 9v1.928l1.715 2.358z"
          />
          <path
            fill="currentColor"
        ...
        <>
          <g clipPath="url(#ATOR__a)">
            <path fill="url(#ATOR__b)" d="M0 0h24v24H0z" />
            <path
              fill="url(#ATOR__c)"
              d="M12 16.714a4.714 4.714 0 1 0 0-9.428 4.714 4.714 0 0 0 0 9.428m0 2.143a6.857 6.857 0 1 0 0-13.714 6.857 6.857 0 0 0 0 13.714"
              fillRule="evenodd"
