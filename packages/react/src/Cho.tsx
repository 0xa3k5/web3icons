...
const IconCho = forwardRef<SVGSVGElement, IconComponentProps>(({ variant = 'mono', ...props }, ref) => (
    ...
    <path fill="#1C4C06" d="M12 19.286a7.286 7.286 0 1 0 0-14.572 7.286 7.286 0 0 0 0 14.572"/>
    <path fill="#CEFF72" d="M12 9c-3 0-3.857 1.929-3.857 3s.784 3 3.857 3c2.927 0 3.857-1.929 3.857-3S15 9 12 9"/>
