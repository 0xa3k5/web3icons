...
const IconSrk = forwardRef<SVGSVGElement, IconComponentProps>(({ variant = 'mono', ...props }, ref) => (
    <BaseIcon {...props} ref={ref}>
      {variant === 'mono' ? (
        <>
          
    <path fill="currentColor" d="M9.857 18.428H5.143l4.714-4.285h4.715zm9-8.571-4.285 4.286V9.857zm0-4.286-4.285 4.286V5.571zm-4.285 4.286-4.715 4.286V9.857zm0-4.286L9.857 9.857V5.571zM9.857 9.857l-4.714 4.286V9.857zm9 4.286-4.285 4.285v-4.285z"/>
