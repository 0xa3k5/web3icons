...
const IconLat = forwardRef<SVGSVGElement, IconComponentProps>(({ variant = 'mono', ...props }, ref) => (
    ...
    <path fill="#050505" d="M8.27 6.857c-.78 0-1.413.605-1.413 1.35v7.222H8.57V8.572h6.857V6.857zm.301 10.286V15.43h6.857V8.572h1.715v7.22c0 .746-.633 1.351-1.413 1.351z"/>
