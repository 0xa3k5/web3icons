...
const IconSrx = forwardRef<SVGSVGElement, IconComponentProps>(({ variant = 'mono', ...props }, ref) => (
    ...
    <path fill="#E23C25" d="M18.857 15.857V12l-3.429 1.928zm-3.429-1.928V10.07L12 12zm0 3.857v-3.858L12 15.859z"/>
    ...
    <path fill="#FAC211" d="M8.571 13.929V10.07L12 12zM12 19.714v-3.857l3.428 1.929z"/>
    <path fill="#E23C25" d="M5.143 12V8.143L8.57 10.07zm0 3.857V12l3.428 1.928z"/>
    <path fill="#FAC211" d="M12 8.143V4.286l3.428 1.928z"/>
    <path fill="#EE8622" d="M15.428 10.071V6.214l3.429 1.929zm0 3.858V10.07L18.857 12z"/>
