...
const IconPop = forwardRef<SVGSVGElement, IconComponentProps>(({ variant = 'mono', ...props }, ref) => (
    ...
    <path fill="url(#POP__a)" d="M6.429 13.714h12V8.571h2.143v6.857H6.429zm-.857 1.714H3.429V8.571h14.143v1.715h-12zm12-2.571v-1.714H6.429v1.714z"/>
    <defs>
        <linearGradient id="POP__a" x1="12.429" x2="9.857" y1="7.714" y2="15.428" gradientUnits="userSpaceOnUse">
