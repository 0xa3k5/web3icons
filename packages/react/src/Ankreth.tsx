...
const IconAnkreth = forwardRef<SVGSVGElement, IconComponentProps>(({ ...props }, ref) => (
    ...
    <path fill="#FFE81C" d="M5.143 8.859v5.905c0 .472.231.909.608 1.145l5.837 3.634c.386.236.853.227 1.23-.021l5.456-3.61a1.35 1.35 0 0 0 .583-1.126v-5.55c0-.463-.223-.892-.583-1.127l-5.485-3.63a1.12 1.12 0 0 0-1.183-.048L5.799 7.685a1.34 1.34 0 0 0-.656 1.175"/>
