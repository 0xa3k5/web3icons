...
const IconBake = forwardRef<SVGSVGElement, IconComponentProps>(
      ...
      {variant === 'mono' ? (
        ...
        <>
          <g clipPath="url(#BAKE__a)">
            <path fill="#FFF2E0" d="M0 0h24v24H0z" />
            <path
              fill="#AD5428"
              d="M19.714 12v-.159c-.055-.355-.287-.977-.823-1.131a4.406 4.406 0 0 1-5.794-5.361c-.069-.54-.364-1.012-1.106-1.042a2 2 0 0 1-.214-.017A7.714 7.714 0 1 0 19.714 12M12 15a3 3 0 1 0 0-6 3 3 0 0 0 0 6"
              fillRule="evenodd"
              clipRule="evenodd"
            />
            <path
