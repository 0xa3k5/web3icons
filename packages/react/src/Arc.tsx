...
const IconArc = forwardRef<SVGSVGElement, IconComponentProps>(
  ({ variant = 'mono', ...props }, ref) => (
    <BaseIcon {...props} ref={ref}>
      {variant === 'mono' ? (
        ...
        <>
          <g clipPath="url(#ARC__a)">
            <path fill="url(#ARC__b)" d="M0 0h24v24H0z" />
            <path
              fill="#fff"
              d="M12.741 6.287A.68.68 0 0 0 12.184 6a.7.7 0 0 0-.557.279L6 14.143a10.4 10.4 0 0 1 2.593-1.354l3.578-5.002 3.416 4.937c.861.287 1.672.686 2.413 1.17z"
            />
            <path
              fill="url(#ARC__c)"
              d="m4.714 17.67-.428.33c.081-.103.227-.214.428-.33 1.732-1.273 5.224-3.343 8.242-3.501 4.114-.215 6.715.852 6.282 2.13-.432 1.277-3.467-.429-6.282-.429-2.473 0-6.785.986-8.242 1.8"
              fillOpacity=".6"
            />
            <path
              fill="url(#ARC__d)"
