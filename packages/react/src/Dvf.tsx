...
const IconDvf = forwardRef<SVGSVGElement, IconComponentProps>(({ variant = 'mono', ...props }, ref) => (
    ...
    <path fill="url(#DVF__b)" d="M12 19.286a7.286 7.286 0 1 0 0-14.572 7.286 7.286 0 0 0 0 14.572m0-.429a6.857 6.857 0 1 0 0-13.713 6.857 6.857 0 0 0 0 13.713" fillRule="evenodd" clipRule="evenodd"/>
    <defs>
        <linearGradient id="DVF__a" x1="5.416" x2="20.05" y1="18.072" y2="14.938" gradientUnits="userSpaceOnUse">
            <stop stopColor="#FCDEA0"/>
            <stop offset=".5" stopColor="#ED5F5E"/>
            <stop offset=".88" stopColor="#67C9CB"/>
        </linearGradient>
        <linearGradient id="DVF__b" x1="16.83" x2="6.171" y1="7.427" y2="15.892" gradientUnits="userSpaceOnUse">
