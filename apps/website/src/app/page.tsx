...
export default function Home() {
  ...
  return (
    <>
      <Head>
        <title>Token Icons – Web3 Icon Library for devs and designers</title>
        <meta
          name="description"
          content="Token Icons is the most comprehensive and up-to-date source for cryptocurrency token & coin logos as icon format. More than 2,500 icons are ready as optimized SVGs as well as React components."
        />
        <meta
          name="keywords"
          content="crypto icons, crypto icons react library, cryptocurrency logos, cryptocurrency logos, icon components, crypto logos, crypto logos react library"
        />
        <meta
          property="og:title"
          content="Token Icons – Web3 Icon Library for devs and designers"
        />
        <meta property="og:description" content="" />
        <meta
          property="og:image"
          content="https://tokenicons.io/og-image.png"
        />
